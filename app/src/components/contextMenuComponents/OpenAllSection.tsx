...
export function OpenAllSection(props: { things: chrome.bookmarks.BookmarkTreeNode[] }): JSX.Element {
  ...
  return <div className="group3  flex flex-col">
    <button onClick={e => openAllChildren(props.things)} disabled={!hasChildrenLinks} className={contextMenuButtonClass}>
      <p>Open all &#40;{childrenLinks.length}&#41;</p>
    </button>
    <button onClick={e => openAllChildren(props.things, { newWindow: true, incognito: false })} disabled={!hasChildrenLinks} className={contextMenuButtonClass}>
      <p>Open all &#40;{childrenLinks.length}&#41; in new window</p>
    </button>
    <button onClick={e => openAllChildren(props.things, { newWindow: true, incognito: true })} disabled={!hasChildrenLinks} className={contextMenuButtonClass}>
